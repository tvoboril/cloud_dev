...
# Base Tools
RUN apt-get update && apt-get install -y sudo curl git wget nano vim zsh unzip tmux openssh-client rsync apt-transport-https ca-certificates gnupg python ruby-full
